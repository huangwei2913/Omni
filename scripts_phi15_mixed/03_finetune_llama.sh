...
INCLUDE_STR="192.168.0.3:0,1,2,3,4,5,6"
...
BASE_MODEL="/mnt/conda_data/checkpoints-pretrain/pretrain_llama/checkpoint-35675"
#由于重新开有问题，那我们就
# [输出] Stage 3 的保存位置
OUTPUT_DIR="./checkpoints-stage3/bunny-llama-full-finetune"

# [数据] Stage 3 的高质量混合数据
DATA_PATH="/mnt/conda_data/Bunny-v1.1-data/finetune/Bunny_TPAMI_Full_Mega_Mix_v3_Fixed.json"
IMAGE_PATH="/"
...
deepspeed \
    ...
    bunny/train/train_stage3_llama.py \
