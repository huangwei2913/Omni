...
#原来Bunny代码中有ClipVisionTower为了和它区别开来
...
#专门用于数据过滤网络的基础网路结构
class ClipVisionTower_(BaseVisionTower):
    def __init__(self, vision_tower_name, args, delay_load=False):
        super(ClipVisionTower_, self).__init__(vision_tower_name, args, delay_load)
    ...
    def load_model(self, device_map=None):
        if self.is_loaded:
            logging.debug(f"{self.vision_tower_name} is already loaded, `load_model` called again, skipping.")
            return
