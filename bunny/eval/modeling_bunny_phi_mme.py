...
def build_vision_tower(vision_tower_cfg, **kwargs):
    ...
    print("build_vision_tower called .....................................",vision_tower)
...
class BunnyMetaModel:
    ...
    def __init__(self, config):
        ...
        print("BunnyMetaModel init called ........................",config)
    ...
    def initialize_vision_modules(self, model_args):
        ...
        print("initialize_vision_modules called ......",model_args)
...
class BunnyMetaForCausalLM(ABC):
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        for batch_idx, cur_input_ids in enumerate(input_ids):
            ...
            cur_input_ids_cat = torch.cat(cur_input_ids_noim).to(device)
            cur_input_embeds = self.get_model().embed_tokens(cur_input_ids_cat)
...
def apply_rotary_pos_emb(q, k, cos, sin, position_ids, unsqueeze_dim=1):
    ...
    """
    print(f"cos device.................: {cos.device}, position_ids device: {position_ids.device}")
...
class PhiAttention(nn.Module):
    ...
    def forward(
        ...
        if attention_mask is not None:
            ...
            print(f"attn_weights device.....: {attn_weights.device}, attention_mask device: {attention_mask.device}")
